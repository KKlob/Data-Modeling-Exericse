...
-- all *_id collumns reference respective table ids
CREATE TABLE tickets (
  ...
  to_city_id INT REFERENCES cities (id) NOT NULL CHECK (to_city_id != from_city_id)
);
...
VALUES
  ...
  (5, '32B', '2019-02-06 16:28:00', '2019-02-06 19:18:00', 6, 14, 16),
