...
-- updated orbits_around + galaxy to reference respective table ids
CREATE TABLE planets (
  id SERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  orbital_period_in_years FLOAT NOT NULL,
  orbits_around INT REFERENCES orbit_objects (id) NOT NULL,
  galaxy INT REFERENCES galaxies (id) NOT NULL,
  moons TEXT[]
  );

INSERT INTO orbit_objects (name)
VALUES
  ('The Sun'),
  ('Proxima Centauri'),
  ('Gliese 876');
